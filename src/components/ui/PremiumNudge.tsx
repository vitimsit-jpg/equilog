...
const NUDGE_CONFIG: Record<string, Record<string, { title: string; desc: string; cta: string }>> = {
  ai_insights: {
    ...
    gerant:          { title: "Alertes santé automatiques", desc: "Recevez des alertes IA dès qu'un pensionnaire présente un signal anormal.", cta: "Passer à Écurie" },
    // Legacy fallbacks
  ...
  multi_horses: {
    ...
    gerant:          { title: "Écurie complète", desc: "Gérez tous vos pensionnaires avec agenda, facturation et messagerie.", cta: "Passer à Écurie" },
    // Legacy fallbacks
  ...
  export: {
    ...
    gerant:          { title: "Facturation automatique", desc: "Générez et envoyez les factures de pension en un clic.", cta: "Passer à Écurie" },
    // Legacy fallbacks
